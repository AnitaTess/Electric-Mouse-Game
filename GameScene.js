...
gameState.information.text = "Both sides lost 1HP!"
gameState.computerSprite.anims.play(gameState.computer.name + 'Attack')
        }
      else if(randomMove === 2){
gameState.computer.health -= 1;
gameState.player.health -= 5;
gameState.computerMove.text = 'Super Attack!'
gameState.information.text = "Electric Mouse lost 5HP and the enemy lost 1HP!";
gameState.computerSprite.anims.play(gameState.computer.name + 'Special')
      }
      else{
gameState.computerMove.text = 'Defence!'
gameState.information.text = "No one was hurt!"
...
gameState.player.sprite.anims.play('playerAttack');
 ...
 let randomMove = Math.floor(Math.random() * 3);
        gameState.playerMove.text = 'Defence!';
        if(randomMove === 0){
gameState.computer.health -= 1;
gameState.computerMove.text = 'Attack!'
gameState.information.text = "Enemy lost 1HP as Electric Mouse defended herself!"
gameState.computerSprite.anims.play(gameState.computer.name + 'Attack')
        }
      else if(randomMove === 2){
gameState.player.health -= 2;
gameState.computerMove.text = 'Super Attack!'
gameState.information.text = "Electric Mouse lost 2HP!";
gameState.computerSprite.anims.play(gameState.computer.name + 'Special')
      }
      else{
gameState.player.health += 2;
gameState.computerMove.text = 'Defence!'
gameState.information.text = "You found some time to heal!"
gameState.computerSprite.anims.play(gameState.computer.name + 'Defend')
      }
      gameState.playerHealthBar.text = `HP: ${gameState.player.health}`;
gameState.computerHealthBar.text = `HP: ${gameState.computer.health}`;
gameState.player.sprite.anims.play('playerDefend');
    ...
    gameState.specialButton.on('pointerup', () => {
      ...
      if (game.input.enabled) {
        let randomMove = Math.floor(Math.random() * 3);
        if (randomMove === 0) {
          gameState.information.text = `You lost 1HP and the enemy lost 5HP!`;
